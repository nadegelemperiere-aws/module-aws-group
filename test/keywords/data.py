...
def load_standard_test_data(arn) :
    ...
    result[0]['data']['InlinePolicy']      = '{\"Statement\":[{\"Action\":[\"s3:ListAllMyBuckets\"],\"Condition\":{\"StringEquals\":{\"aws:RequestedRegion\":[\"eu-west-1\"]}},\"Effect\":\"Allow\",\"Resource\":[\"*\"],\"Sid\":\"AllowS3Listing\"},{\"Action\":[\"s3:GetObject\"],\"Effect\":\"Allow\",\"Resource\":[\"*\"],\"Sid\":\"AllowS3Reading\"}],\"Version\":\"2012-10-17\"}'
    result[0]['data']['Tags'] = []
